...
export async function initializeDatabase(db: SQLiteDatabase) {
  ...
  await db.execAsync(`
    ...
    DROP TABLE IF EXISTS starting_kits;
  `);
  ...
  // 4. INSERÇÃO DE ITENS COM DESCRICAO
  ...
  `);
    // 4.1 INSERÇÃO DOS KITS INICIAIS
  ...
  // 5. RAÇAS (Agora incluindo os 'speed' dinâmicos)
  ...
  // 6. CLASSES (Agora incluindo hp, saves, quando pega subclasse e se tem magia)
  ...
  // 7. OUTROS DADOS (Saves, Skills, Spells e Subclasses - Mantidos)
