...
export const sheetStyles = StyleSheet.create({
  ...
  publicEffectModalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.82)', justifyContent: 'center', alignItems: 'center', paddingHorizontal: 18, paddingVertical: 28 },
  publicEffectBackdrop: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0 },
  publicEffectModalPanel: { width: '100%', maxWidth: 420, maxHeight: '76%', backgroundColor: '#02112b', borderRadius: 22, padding: 16, borderWidth: 1, borderColor: 'rgba(0,191,255,0.45)' },
  publicEffectModalHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 },
  publicEffectModalIcon: { width: 36, height: 36, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,191,255,0.12)', borderWidth: 1, borderColor: 'rgba(0,191,255,0.35)' },
  publicEffectModalTitle: { color: appColors.textPrimary, fontSize: 17, fontWeight: 'bold' },
  publicEffectModalSubtitle: { color: appColors.textMuted, fontSize: 11, marginTop: 3 },
  publicEffectModalClose: { width: 36, height: 36, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.08)' },
  publicEffectModalList: { maxHeight: 430 },
  publicEffectModalRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: 'rgba(255,255,255,0.045)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 13, padding: 12, marginBottom: 8 },
  publicEffectDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: appColors.success, flexShrink: 0 },
  publicEffectModalName: { color: appColors.textPrimary, fontSize: 14, fontWeight: 'bold' },
  publicEffectModalMeta: { color: appColors.textMuted, fontSize: 11, lineHeight: 16, marginTop: 3 },
  publicEffectModalEmpty: { color: appColors.textMuted, fontSize: 13, lineHeight: 20, textAlign: 'center', paddingVertical: 24 },
  publicEffectTrashButton: { width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', backgroundColor: appColors.dangerSoft, borderWidth: 1, borderColor: 'rgba(255,102,102,0.35)' },
  ...
  tradePanel: { backgroundColor: '#02112b', width: '94%', maxHeight: '92%', borderRadius: 18, padding: 14, borderWidth: 1, borderColor: 'rgba(0,191,255,0.35)', overflow: 'hidden' },
  tradeBoard: { flexDirection: 'row', gap: 8, marginVertical: 10, alignItems: 'stretch' },
  tradeColumn: { flex: 1, minWidth: 0, backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', borderRadius: 12, padding: 8, minHeight: 132 },
  tradeColumnTitle: { color: '#00bfff', fontSize: 10, fontWeight: 'bold', marginBottom: 8, textTransform: 'uppercase', textAlign: 'center' },
  tradeSlot: { borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', borderRadius: 10, minHeight: 64, padding: 8, justifyContent: 'center' },
  tradeSlotActive: { borderColor: '#00fa9a', backgroundColor: 'rgba(0,250,154,0.08)' },
  tradeSlotName: { color: '#fff', fontSize: 12, fontWeight: 'bold', flexShrink: 1, textAlign: 'center' },
  tradeSlotMeta: { color: 'rgba(255,255,255,0.45)', fontSize: 10, marginTop: 4, flexShrink: 1, textAlign: 'center' },
  tradeArrowBox: { alignItems: 'center', justifyContent: 'center', width: 22, flexShrink: 0 },
  tradeList: { maxHeight: 180, marginTop: 8 },
  ...
  tradeActionButton: { flexDirection: 'row', backgroundColor: 'rgba(0,191,255,0.1)', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(0,191,255,0.3)', gap: 8, minWidth: 0 },
  tradeActionButtonText: { color: '#00bfff', fontWeight: 'bold', fontSize: 14, flexShrink: 1, textAlign: 'center' },
  tradeQtyRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8 },
  tradeQtyBtn: { backgroundColor: 'rgba(255,255,255,0.1)', width: 34, height: 34, borderRadius: 10, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  tradeQtyBtnText: { color: '#00bfff', fontSize: 21, fontWeight: 'bold', lineHeight: 24 },
  tradeQtyVal: { color: '#fff', fontSize: 15, fontWeight: 'bold', minWidth: 24, textAlign: 'center' },
...
export const advancedStyles = StyleSheet.create({
  ...
  ruleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, paddingVertical: 10 },
  ruleTextBox: { flex: 1 },
  ruleTitle: { color: '#fff', fontSize: 13, fontWeight: 'bold', marginBottom: 4 },
  ruleDescription: { color: 'rgba(255,255,255,0.55)', fontSize: 12, lineHeight: 17 },
